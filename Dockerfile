...
# Install agent-browser, claude-code, and GitHub MCP server globally
RUN npm install -g agent-browser @anthropic-ai/claude-code @modelcontextprotocol/server-github
...
RUN mkdir -p /workspace/group /workspace/global /workspace/extra /workspace/ipc/messages /workspace/ipc/tasks /workspace/ipc/input /workspace/ipc/swe
